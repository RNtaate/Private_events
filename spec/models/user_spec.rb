...
RSpec.describe User, type: :model do
  ...
  context 'associations between user and event model' do
    it 'user can create many events' do
      ...
      u.created_events.create(description: 'Big party', date: Date.today + 5)
      u.created_events.create(description: 'Huge party', date: Date.today + 15)
      expect(Event.second.description).to eql('Huge party')
    end
  end
